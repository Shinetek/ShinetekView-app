...
(function () {
    ...
    function _getDataListByCondition(req, res, next) {
        ...
        if (_.isUndefined(req.params.SatID) || _.isUndefined(req.params.InstID) || _.isUndefined(req.params.ProdName) || _.isUndefined(req.params.Resolution)) {
            res.end("请确认参数如下格式：/datalist/:SatID/:InstID/:ProdName/:Resolution" + "1SatID:" + req.params.SatID + "2InstID:" + req.params.InstID + "3ProdName:" + req.params.ProdName + "4Resolution:" + req.params.Resolution);
            next();
        }
        //获取Select 语句
        var _SQL = " SELECT  DISTINCT(DataTime) FROM ProductInfo  " + " where  SatID ='" + req.params.SatID + "' and InstrumentName ='" + req.params.InstID + "' and ProductName ='" + req.params.ProdName + "' and Resolution =" + req.params.Resolution + " and IsExitFlag = 1 order by CreatTime desc" + " limit 1000";
    ...
    function _getDataListByFY4A(req, res, next) {
        ...
        if (_.isUndefined(req.params.SatID) || _.isUndefined(req.params.InstID) || _.isUndefined(req.params.ProdName) || _.isUndefined(req.params.Resolution) || _.isUndefined(req.params.ObserveType)) {
            res.end("请确认参数如下格式：/datalist/:SatID/:InstID/:ProdName/:ObserveType/:Resolution" + "1SatID:" + req.params.SatID + "2InstID:" + req.params.InstID + "3ProdName:" + req.params.ProdName + "4ObserveType:" + req.params.ObserveType + "5Resolution:" + req.params.Resolution);
            next();
        }
        //获取Select 语句
        var _SQL = " SELECT  * FROM ProductInfo  " + " where  SatID ='" + req.params.SatID + "' and InstrumentName ='" + req.params.InstID + "' and ProductName ='" + req.params.ProdName + "' and Resolution =" + req.params.Resolution + " and ObserveType ='" + req.params.ObserveType + "' and IsExitFlag = 1 order by CreatTime desc" + " limit 1000";
        console.log(_SQL);
    ...
    function _getDataListByFY4A_all(req, res, next) {
        //从数据库中获取 FY4A版本 的 全状态数据 。
        if (_.isUndefined(req.params.SatID) || _.isUndefined(req.params.InstID) || _.isUndefined(req.params.ProdName) || _.isUndefined(req.params.Resolution)) {
            res.end("请确认参数如下格式：/datalist/:SatID/:InstID/:ProdName/:ObserveType/:Resolution" + "1SatID:" + req.params.SatID + "2InstID:" + req.params.InstID + "3ProdName:" + req.params.ProdName + "5Resolution:" + req.params.Resolution);
            next();
        }
        //获取Select 语句
        var _SQL = " SELECT  * FROM ProductInfo  " + " where  SatID ='" + req.params.SatID + "' and InstrumentName ='" + req.params.InstID + "' and ProductName ='" + req.params.ProdName + "' and Resolution =" + req.params.Resolution + " and IsExitFlag = 1 order by CreatTime desc" + " limit 1000";
        console.log(_SQL);
    ...
    function _getTimeStrFormDataTime(timeStr, timeMode) {
        ...
        switch (timeMode) {
            ...
            case "minute":
                {
                    returnTimeStr = timeStr.substr(0, 4) + "-" + timeStr.substr(4, 2) + "-" + timeStr.substr(6, 2) + " " + timeStr.substr(9, 2) + ":" + timeStr.substr(11, 2);
                    break;
                }
            default:
                break;
...
//# sourceMappingURL=datalist-handler-compiled.js.map